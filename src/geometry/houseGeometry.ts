...
import type { HouseProject, Slab, Storey } from "../domain/types";
import { buildBalconyGeometry } from "./balconyBuilder";
import type { FootprintQuad, HouseGeometry } from "./types";
...
export function buildSceneGeometry(project: HouseProject): HouseGeometry {
