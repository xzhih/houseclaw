// Stair-related geometry helpers used across the v2 canvas / projection /
// geometry layers. Pure math, no domain types — keeps this file
// dependency-free so it can be imported anywhere.

const TARGET_RISER = 0.165;

/** Rotate point `p` around `center` by `angleRad` radians (CCW positive). */
